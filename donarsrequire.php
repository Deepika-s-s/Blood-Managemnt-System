...
<center>
<div>
            <h1 class="header">Blood Require Details</h1>
            ...
            <div>
                ...
                ?>
                <tr  class="active-row">
                    <td><?php echo $res['uid'];?></php></td>
                    <td><?php echo $res['namere'];?></php></td>
                    <td><?php echo $res['blood_groupre'];?></php></td>
                    <td><?php echo $res['contact'];?></php></td>
                    <td><?php echo $res['Placee'];?></php></td>
